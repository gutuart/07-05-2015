...
<html>
	...
	<body>
		<div class="calendar" data-color="normal"><div data-role="day" data-day="<?php echo date("Ynd",mktime(0,0,0,date("m"),date("d")+1,date("Y"))); ?>"><div data-role="event" data-name="Gala de proyectos" data-start="8.30 pm" data-end="9.00 pm" data-location="Unisangil"></div></div></div>
	<script>
	var yy;
	var calendarArray =[];
